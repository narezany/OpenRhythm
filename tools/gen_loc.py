...
add("Then watch closely — I'll show you everything myself!",
    "Тогда смотри внимательно — я всё покажу сама!",
    "那就看仔细了——我亲自教你！",
...
add("So you survived the night drive. Cute.",
    "Значит, ночную поездку ты пережил. Мило.",
    "所以你熬过了夜间驾驶。可爱。",
    "Du hast die Nachtfahrt also überlebt. Niedlich.",
    "Dus je hebt de nachtrit overleefd. Schattig.",
    "Así que sobreviviste al viaje nocturno. Qué mono.")
add("This one hits harder. Faster drums, wobblier bass, no mercy.",
    "Этот бьёт сильнее. Барабаны быстрее, бас злее, без пощады.",
    "这次更狠。鼓更快，贝斯更晃，毫不留情。",
    "Das hier knallt härter. Schnellere Drums, wobbliger Bass, keine Gnade.",
    "Deze slaat harder. Snellere drums, wobbelende bas, geen genade.",
    "Este pega más fuerte. Batería más rápida, bajo más sucio, sin piedad.")
add("Hands on the cursor. Try to keep up with me.",
    "Руки на курсор. Попробуй за мной успеть.",
    "手放好光标。试着跟上我。",
    "Hände an den Cursor. Versuch mitzuhalten.",
    "Handen aan de cursor. Probeer me bij te houden.",
    "Manos al cursor. Intenta seguirme el ritmo.")
